...
var CardWidget = function ($) {
  ...
  var CardWidget = /*#__PURE__*/function () {
    ...
    _proto.minimize = function minimize() {
      this._parent.find(` ${this._settings.maximizeTrigger} .${this._settings.minimizeIcon}`).removeClass(this._settings.minimizeIcon);
...
jQuery.CardRefresh = CardRefresh;
jQuery.CardWidget = CardWidget;
jQuery.ControlSidebar = ControlSidebar;
jQuery.DirectChat = DirectChat;
jQuery.Dropdown = Dropdown;
jQuery.Layout = Layout;
jQuery.PushMenu = PushMenu;
jQuery.Toasts = Toasts;
